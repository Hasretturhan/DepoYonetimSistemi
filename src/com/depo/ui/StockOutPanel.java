...
public class StockOutPanel extends JPanel {
    ...
    private final JButton btnOut = new JButton("Stok Çıkışı Yap");

    public StockOutPanel(WarehouseService service) {
        this.service = service;

        setLayout(new GridBagLayout());
        setBorder(BorderFactory.createTitledBorder("Stok Çıkış"));
    ...
    private void hookEvents() {
        btnOut.addActionListener(e -> {
            try {
                ...
                service.stockOut(p.getCode(), amount);
